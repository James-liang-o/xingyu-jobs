...
.citytag{padding:10px 16px;background:#fff}
  ...
  .tieba-entry{background:linear-gradient(90deg,#ECFDF5,#D1FAE5);border-bottom:1px solid #A7F3D0;padding:9px 16px;font-size:13px;color:#065F46;display:flex;align-items:center;gap:8px;cursor:pointer}
...
<div class="tieba-entry" onclick="window.open('https://tieba.baidu.com/f?kw=%E5%BF%83%E7%90%86%E9%9A%9C%E7%A2%8D%E5%B0%B1%E4%B8%9A','_blank','noopener')">
  <span class="ntag teal">社区</span>
  <span class="ntxt">心理障碍就业吧已开通，来聊聊求职路上的故事、经验和疑问</span>
  <span class="ngo">进吧 ›</span>
</div>
...
<div class="detailpage" id="detailPage">
  ...
  <div class="dt-card">
    ...
    <div class="dt-note" style="margin-top:8px">发现该岗位虚假、可疑或已失效？<a class="fm" href="mailto:1739528214@qq.com?subject=行隅岗位举报：请填写岗位名称&body=举报岗位：请填写岗位名称%0A岗位来源：%0A举报原因：虚假招聘 / 诈骗 / 其他">点击邮件举报 ›</a> 我们将及时处理下架。</div>
  </div>
</div>
